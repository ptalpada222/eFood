        ...
        <div className="flex justify-center self-center ">
          <div className="p-12 bg-white mx-auto rounded-3xl w-[470px] border-gray-200 border">
            ...
            <div className="space-y-6">
              ...
              {/* Button */}
              <button className="w-full flex justify-center bg-yellow-400 hover:bg-[#ffbe33] text-gray-100 p-3 rounded-lg tracking-wide font-semibold transition duration-500">
                Sign in
              </button>
              ...
              <div className="flex flex-row  w-full border rounded-lg transition p-3 border-gray-300 hover:bg-yellow-400  hover:text-white">
                ...
                <button className="mx-14">Google</button>
              </div>
            </div>
